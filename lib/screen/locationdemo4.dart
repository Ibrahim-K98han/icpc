...
class LocationDemo4 extends StatefulWidget {
  const LocationDemo4({Key? key}) : super(key: key);

  @override
  State<LocationDemo4> createState() => _LocationDemo4State();
}

const kGoogleApiKey = 'AIzaSyA-Nfa895raXEBDOUjzIcKEYQxPAMqvLM0';

class _LocationDemo4State extends State<LocationDemo4> {
  final Completer<GoogleMapController> _controller = Completer();

  static const LatLng sourceLocation = LatLng(23.8118171, 90.3574052);
  static const LatLng destination = LatLng(23.8121435, 90.3567429);
