...
class LocationDemo3 extends StatefulWidget {
  const LocationDemo3({Key? key}) : super(key: key);

  @override
  State<LocationDemo3> createState() => _LocationDemo3State();
}

const kGoogleApiKey = 'AIzaSyA-Nfa895raXEBDOUjzIcKEYQxPAMqvLM0';

class _LocationDemo3State extends State<LocationDemo3> {
  final Completer<GoogleMapController> _controller = Completer();

  static const LatLng sourceLocation = LatLng(23.8118171, 90.3574052);
  static const LatLng destination = LatLng(23.8117794, 90.3570341);
