...
class LocationDemo2 extends StatefulWidget {
  const LocationDemo2({Key? key}) : super(key: key);

  @override
  State<LocationDemo2> createState() => _LocationDemo2State();
}

const kGoogleApiKey = 'AIzaSyA-Nfa895raXEBDOUjzIcKEYQxPAMqvLM0';

class _LocationDemo2State extends State<LocationDemo2> {
